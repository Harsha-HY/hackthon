...
|---|---|---|---|---|
| 1 | Pitch + Code Walkthrough Video (≤ 10 min, MP4) | `<https://drive.google.com/file/d/192uzlkESFvdssvq-ZPC_QtslmV2pCRxh/view?usp=drivesdk` | `<HM26-337B>_video.mp4` | `<...>` |
| 2 | Decision Log (1 page, PDF) | `<https://drive.google.com/file/d/1-6gfQ-0lTgQVWcpcar2sJv7yIo_nUalI/view?usp=drivesdk` | `<HM26-337D>_decision-log.pdf` | `<...>` |
| 3 | Presentation (≤ 10 slides, PDF) | `<https://docs.google.com/presentation/d/1LeDL_zenFMHtF2BpFimdZOoHGYegKOYZ/edit?usp=drivesdk&ouid=116819381280222425259&rtpof=true&sd=true` | `<HM26-337B>_presentation.pdf` | `<...>` |
